...
# arguments to generate csv data
max_length = 512
tokenizer = AutoTokenizer.from_pretrained('gogamza/kobart-base-v1')
save_path = '/home/ailab/Desktop/NY/2023_ipactory/data/csv/data.csv'
...
def gen_data(datalists) :
    rest = []
    dataframe = {
        'encoder_input' : [],
        'decoder_input' : []
    }
    for file in tqdm(datalists) :
        truncated, rest = truncate(file, max_length - 2, rest, tokenizer)
        
    

def gen_data(max_length : int, tokenizer, save_path : str, init : bool, datalists : list) :
...
if __name__ == "__main__" :
    ...
    gen_data(512, tokenizer, '/home/ailab/Desktop/NY/2023_ipactory/data/csv/data.csv', True, datalists)
    # valid
