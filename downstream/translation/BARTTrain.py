...
if __name__ == "__main__" :
    ...
    g2.add_argument("--score_mode", type=str, default="kor_bleu")
    ...
    elif 'bleu' in args.score_mode :
        checkpoint_callback = pl.callbacks.ModelCheckpoint(
                                    monitor='valid_bleu',
                                    dirpath=args.save_ckpt_dir,
                                    filename='{epoch:02d}-{valid_bleu:.3f}',
                                    verbose=False,
                                    save_last=True,
                                    mode='max',
                                    save_top_k=1
    ...
    model = Translate(args, tokenizer)
