...
if __name__ == "__main__" :
    ...
    g1.add_argument("--ckpt_path", type=str, default="/home/nykim/23_ipactory/01_downstream/aihub_sum/01_bart_ckpt/1900000/epoch=04-valid_rouge1=0.542-valid_rouge2=0.421-valid_rougel=0.534.ckpt")
    g1.add_argument("--gpu_lists", type=str, default="1", help="string; make list by splitting by ','") # gpu list to be used
    ...
    model = AIHUBSummarization.load_from_checkpoint(checkpoint_path=args.ckpt_path, args=args, tokenizer=tokenizer)
